...
function MyNavbar(props) {
    return (
        ...
        <Navbar>
            ...
            <div class="navbar-nav ms-md-auto" id="nav">
                <p class="nav-item nav-link" >
                    <span style={{ paddingRight: '5px' }}>Welcome {props.name}!</span>
                    <a href="#"><svg class="bi bi-people-circle" width="30" height="30" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
